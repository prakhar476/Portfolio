 ...
 * Icons.jsx
 * ------------------------------------------------------------
 * Small inline SVG icons, kept as simple functional components
 * so we avoid pulling in an icon library dependency. Each accepts
 * an optional `size` prop (defaults shown per-icon).
 * ------------------------------------------------------------
 */
